...
date: 2020-09-14
categories: [ML, Python-libraries, Exposition]
---
<!-- 
======================================================================
                         QUARTO CHEAT SHEET
...
## Prerequisites
We'll assume you that you have read [this post](2020-09-13-least-squares.qmd) on least-squares solution and the normal equation.
...
The numpy code to find transposes, inverses, take dot products or multiply matrices is easy. In particular,

- `X.T` is the transpose of $X$
- `np.linalg.inv(X)` is $X^{-1}$
...
![Viz of predictions](../assets/2020-09-14-predictions-vs-truth.png)
...
The root mean squared error on our test-data set from our decision tree regressor on the same dataset [earlier](2020-09-01-decision-tree-regressor.qmd) was around 1.77. We see that the root mean squared error has gone down to 1.56 for our linear regressor.
