...
![Detecting cycles using hares and tortoises](../assets/2020-09-30-tortoise-hare.png){width=75%}
...
![Eureka!](/assets/2020-09-30-bulb.png){width=20%}
...
def hasCycle(head: ListNode) -> bool:
    ...
    while(fast_pointer is not None):
        ...
        if slow_pointer == fast_pointer:
            return True
        # if the fast pointer is one step before the end of the linked list, return False
